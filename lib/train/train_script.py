...
# network related
from lib.models.stltrack import build_stltrack
# forward propagation related
from lib.train.actors import STLTrackActor
# for import modules
import importlib
...
def run(settings):
    ...
    # Create network
    if settings.script_name == "stltrack":
        net = build_stltrack(cfg)
    else:
    ...
    if settings.script_name == "stltrack":
        ...
        actor = STLTrackActor(net=net, objective=objective, loss_weight=loss_weight, settings=settings, cfg=cfg, multiFrame=False)
    else:
        raise ValueError("illegal script name")
