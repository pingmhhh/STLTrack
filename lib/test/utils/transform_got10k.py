...
def transform_got10k(tracker_name, cfg_name):
    ...
    src_dir = os.path.join(result_dir,tracker_name, cfg_name,"got10k")
    dest_dir = os.path.join(result_dir,tracker_name, cfg_name,"got10k_submit")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str, help='Name of tracking method.',default='')
    parser.add_argument('--cfg_name', type=str, help='Name of config file.',default='')
